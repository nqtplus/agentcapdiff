...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="agentcapdiff", description="Audit and diff AI-agent capabilities.")
    ...
    snap_p = sub.add_parser("snapshot", help="Write a capability snapshot for later diffing.")
